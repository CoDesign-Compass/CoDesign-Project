...
export default function CreateNewIssue() {
  ...
  // Temporary shareId generator.
  // In production this should be generated by the backend and guaranteed to be unique.
  ...
  const handleSubmit = async () => {
    ...
    try {
      // Simulate issue creation (until backend API is connected)
      ...
      console.log('Published Issue:', newIssue)
