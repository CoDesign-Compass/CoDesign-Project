...
import { Layout, Menu, ConfigProvider } from "tdesign-react";
...
export default function AdminLayout() {
  ...
  return (
    // ✅ 仅在 Admin 区域包 ConfigProvider（英文）
    <ConfigProvider globalConfig={enUS}>
      <Layout style={{ height: "100vh", backgroundColor: "#fafafa" }}>
        ...
        <Layout>
          ...
          <Content
            style={{ padding: "2rem", backgroundColor: "#fafafa", overflowY: "auto" }}
          >
            <Outlet />
          </Content>
        </Layout>
